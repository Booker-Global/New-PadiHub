...
export const FAQ_ENTRIES: FAQEntry[] = [
  ...
  { q: 'How much does PadiHub cost?', a: 'PadiHub has two monthly-only plans. Pro Group: £4.99/month (UK) or ₦5,000/month (Nigeria). Create ONE savings group; be a member of up to 5 groups total. Elite Group: £9.99/month (UK) or ₦10,000/month (Nigeria). Create up to SEVEN savings groups; be a member of up to 10 groups total.' },
